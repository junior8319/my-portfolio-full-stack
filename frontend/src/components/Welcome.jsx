  ...
  return (
    <Article>
          ...
          <SimpleP>
            ...
            Nesta seção haverá artigos que serão publicados com intenção de fazer contribuições acadêmicas ao assunto, os quais poderão receber devolutivas com sugestões e comentários.
          </SimpleP>
          <SimpleP>
